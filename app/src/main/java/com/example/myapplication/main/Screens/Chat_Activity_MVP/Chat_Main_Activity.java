...
public class Chat_Main_Activity extends AppCompatActivity implements Chat_view {
    ...
    private boolean checkCurrentPermission() {
        if (Check_Permission_Service.checkPermission(this, Chat_Main_Activity.this, Manifest.permission.CAMERA, App_Constants.CAMERA_REQUEST_CODE)
                && Check_Permission_Service.checkPermission(this, Chat_Main_Activity.this, Manifest.permission.READ_EXTERNAL_STORAGE, App_Constants.READING_REQUEST_CODE)
                && Check_Permission_Service.checkPermission(this, Chat_Main_Activity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE, App_Constants.WRITE_REQUEST_CODE)) {
            return true;
        }
        return false;
    }
